<template>
    <div class="p-8">
        ...
        <div class="tabs border-b border-grey-light">
            <div class="tab" v-for="(group, $i) in groups" :key="$i" @click="activeTab = $i" :class="{'tab--active': activeTab == $i}">{{ group.title }}</div>
        </div>
            ...
            <template v-if="! loading">
                <div class="editable-list bg-white shadow-md rounded">
                    <table class="text-left w-full border-collapse">
                        ...
                        <tr v-for="(translations, original) in activeGroup.phrases" :key="original" class="hover:bg-grey-lighter">
                            ...
                            <td class="py-1 px-6 border-b border-grey-light w-1/2">
                                <div class="pl-8 relative my-2" v-for="(phrase, locale) in translations">
                                    <form-label :labelFor="phrase + locale"
                                                class="capitalize absolute pin-l font-normal"
                ...
                <div v-if="! Object.keys(groups).length" class="flex justify-center items-center px-6 py-8">
    ...
    export default {
        ...
        methods: {
            ...
            save(locale, original, phrase) {
                ...
                if (self.activeGroup.phrases[original][locale] == phrase)
                    return
